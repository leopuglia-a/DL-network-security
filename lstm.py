...
df = pd.read_csv("dataset/full-dataset.csv", low_memory=True)
...
for train_index, test_index in kf.split(X, Y):
    ...
    # add model layers
    model.add(LSTM(units=200, dropout=0.2, recurrent_dropout=0.2, kernel_regularizer=l2(0.01), bias_regularizer=l2(0.01), input_shape=(history_length, n_features)))
